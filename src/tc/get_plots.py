...
data_files = {
        "mBERT_ConceptNet_Baseline": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/conceptnet_mbert_baseline_results.csv',
        "mBERT_ConceptNet_Seq_bn": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/conceptnet_mbert_seq_bn_results.csv',
        "mBERT_ConceptNet_LoRA": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/conceptnet_mbert_lora_results.csv',
        "mBERT_ConceptNet_Seq_bn_inv": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/conceptnet_mbert_seq_bn_inv_results.csv',
        
        "XLM-R_ConceptNet_Baseline": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/glot_xlm-r_baseline_results.csv',
        "XLM-R_ConceptNet_Seq_bn": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/conceptnet_xlm-r_seq_bn_results.csv',
        "XLM-R_ConceptNet_LoRA": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/conceptnet_xlm-r_lora_results.csv',
        "XLM-R_ConceptNet_Seq_bn_inv": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/conceptnet_xlm-r_seq_bn_inv_results.csv',
    
        "mBERT_Glot_Seq_bn": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/glot_mbert_seq_bn_results.csv',
        "mBERT_Glot_LoRA": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/glot_mbert_lora_results.csv',
        "mBERT_Glot_Seq_bn_inv": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/glot_mbert_seq_bn_inv_results.csv',
        
        "XLM-R_Glot_Seq_bn": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/glot_xlm-r_seq_bn_results.csv',
        "XLM-R_Glot_LoRA": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/glot_xlm-r_lora_results.csv',
        "XLM-R_Glot_Seq_bn_inv": '/netscratch/dgurgurov/thesis/downstream_tasks/tc/glot_xlm-r_seq_bn_inv_results.csv'
}
...
def load_tc_results(data_files):
    results = {}
...
tc_results = load_tc_results(data_files)

# Combine the results into a single DataFrame
combined_results = pd.concat(tc_results.values(), ignore_index=True)
...
def plot_tc_results(results, title, save_path):
...
# Plot for mBERT
plot_tc_results(mbert_results, "mBERT TC Performance", './plots/mBERT_tc_comparison_bars.png')

# Plot for XLM-R
plot_tc_results(xlmr_results, "XLM-R TC Performance", './plots/XLM-R_tc_comparison_bars.png')
