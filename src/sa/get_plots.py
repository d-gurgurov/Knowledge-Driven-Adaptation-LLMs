...
# Plot for mBERT
plot_tc_results(mbert_results, "mBERT SA Performance", './plots/mBERT_sa_comparison_bars.png')

# Plot for XLM-R
plot_tc_results(xlmr_results, "XLM-R SA Performance", './plots/XLM-R_sa_comparison_bars.png')
